...
There is an R script in the same directory that shows you how to add a course to the dataframe `adding_course.R`. It is important that you include ALL COLUMNS when adding new entries -- otherwise the data will be messy. 
